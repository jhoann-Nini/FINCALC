...
const STEPS = [
  {
    ...
    title: '¡Bienvenido a Finametrics!',
    desc: 'Tu plataforma de Ingeniería Económica — porque todo cuesta. Esta guía rápida te muestra cómo aprovechar la app al máximo.',
    detail: null,
  },
  {
