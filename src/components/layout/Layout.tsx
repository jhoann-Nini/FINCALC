...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/gradientes', label: 'Gradientes', icon: BarChart3 },
    ],
  },
  {
    group: 'Practicar',
...
// ── Marca: barras ascendentes (métricas) + línea de tendencia ──
export function BrandMark({ size = 34 }: { size?: number }) {
  ...
  return (
    ...
    >
      ...
      {/* barras */}
      <rect x="9" y="20" width="3.4" height="7" rx="1.5" fill="#fff" opacity="0.55" />
      <rect x="16.3" y="16" width="3.4" height="11" rx="1.5" fill="#fff" opacity="0.75" />
      <rect x="23.6" y="11" width="3.4" height="16" rx="1.5" fill="#fff" />
      {/* línea de tendencia ascendente */}
      <path
        d="M8 23 L16 18.5 L24 13 L29 9"
        stroke="#fff"
        strokeWidth="1.8"
        strokeLinecap="round"
        ...
        opacity="0.9"
      />
      <circle cx="29" cy="9" r="2.1" fill="#fff" />
    </svg>
  )
}
  ...
  return (
    <div className="flex min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      >
        ...
        >
          <NavLink to="/" className="flex items-center gap-3" style={{ textDecoration: 'none' }}>
            ...
            <span className="flex flex-col" style={{ lineHeight: 1 }}>
              ...
              >
                Fina<span style={{ color: 'var(--accent)' }}>metrics</span>
              </span>
              <span
                style={{
        ...
        {/* Footer */}
        <div className="px-4 py-3 border-t flex flex-col gap-0.5" style={{ borderColor: 'var(--border)' }}>
          <span
            className="text-xs"
            style={{ color: 'var(--accent)', fontFamily: 'Fraunces, serif', fontStyle: 'italic', fontSize: 13 }}
          >
            «todo cuesta»
          </span>
          <span style={{ color: 'var(--muted)', fontFamily: 'JetBrains Mono', fontSize: 10, letterSpacing: '0.06em' }}>
            Ingeniería Económica · 2026
          </span>
        </div>
      </aside>
