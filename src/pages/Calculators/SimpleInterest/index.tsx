...
export default function SimpleInterestPage() {
  ...
  return (
    <div className="p-6 lg:p-10 max-w-4xl mx-auto">
      ...
      <GlossaryChips terms={['interes-simple', 'capital', 'monto', 'interes', 'tasa-periodica']} />
      ...
      {result && (
        <div className="animate-fade-up">
          ...
          <StepByStep steps={buildSimpleSteps(result, mode, nUnit)} contexto="interés simple" />

          <MicroQuiz module="interes-simple" />
